...
CAMERA_CONFIG = {
    'right': {
        ...
        'result_file': os.path.join(DATA_DIR, 'calibration_result_right.yaml'),
    ...
    'left': {
        ...
        'result_file': os.path.join(DATA_DIR, 'calibration_result_left.yaml'),
        'viz_file': os.path.join(DATA_DIR, 'calibration_detect_left.png'),
    },
}

# 기존 파일 호환 (right 카메라)
LEGACY_DATA_FILE = os.path.join(DATA_DIR, 'calibration_data.json')
LEGACY_RESULT_FILE = os.path.join(DATA_DIR, 'calibration_result.yaml')
